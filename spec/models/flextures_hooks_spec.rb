...
describe Flextures do
  describe "RSpec::Hooks" do
    ...
    describe "::flextures_options" do
      ...
      @@flextures_loader = flextures_get_options

      it "option is setted" do
        @@flextures_loader.flextures_options.should == { cache: true }
      end
      ...
      context "add option" do
        ...
        it "option is added" do
          @@flextures_loader.flextures_options.should == { cache: true, unfilter: true }
        end
      end

      context "new context" do
        it "added option is exist" do
          @@flextures_loader.flextures_options.should == { cache: true, unfilter: true }
        end
      end
    end
